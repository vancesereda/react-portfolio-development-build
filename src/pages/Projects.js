                ...
                <Container>
                    ...
                    <Col /* lg={{size: 10, offset: 1}} */ xs="12">
                        ...
                        <div id="weather">
                            ...
                            Axios & DarkSky API for API calls, and WeatherIcons. API calls rerouted through Amazon API Gateway for CORS passthrough. <strong>Please make sure to enable location for this app.</strong></p> <br />
                            <br />
                        </div>
