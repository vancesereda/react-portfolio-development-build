...
<Row>
    ...
    <Col xs={{size:10, offset:1}} lg={{size:8, offset:2}} >
        ...
        <img className="img-responsive img profile-img" src="/vance.jpg" alt="avatar" />
            ...
            <p className="front-page-intro-p"> I'm a B.S. Chem. Eng. '18  turned software engineer, currently living in Seattle, WA.
            I'm a  <strong> front end </strong> and  <strong> mobile engineer </strong>experienced with <strong> React, React Native, Java, Python</strong> and <strong> cloud-based serverless architecture </strong> with AWS.
            </p>
